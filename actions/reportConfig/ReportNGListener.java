...
public class ReportNGListener implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		Reporter.log("<br><a target=\"_blank\" href=\"file:///" + screenshotPath + "\">" + "<img src=\"file:///" + screenshotPath + "\" width=\"150\" height=\"100\">" + "</a></br>");
	...
	public String captureScreenshot(WebDriver driver, String screenshotName) {
		try {
			...
			String screenPath = System.getProperty("user.dir") + "\\ReportNGScreenshot\\" + screenshotName + "_" + formater.format(calendar.getTime()) + ".png";
